...
public class WordsGrid : MonoBehaviour
{
    ...
    private void SetSquaresPosition()
    {
        ...
        var squareTransfrom = _squareList[0].GetComponent<Transform>();
        var offset = new Vector2
        {
            x = (squareRect.width * squareTransfrom.localScale.x + squareOffset) * 0.01f,
            y = (squareRect.height * squareTransfrom.localScale.y + squareOffset) * 0.01f
        };
    ...
    private Vector2 GetFirstSquarePosition()
    {
        ...
        squareSize.x = squareRect.width * squareTransfrom.localScale.x;
        squareSize.y = squareRect.height * squareTransfrom.localScale.y;
